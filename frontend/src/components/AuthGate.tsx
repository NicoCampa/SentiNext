        ...
        <main className="flex min-h-screen items-center justify-center bg-[rgb(5,5,15)] px-6 py-16 relative overflow-hidden">
          ...
          <div className="relative w-full max-w-lg space-y-8">
            ...
            <div className="text-center space-y-6">
              <div className="mx-auto w-20 h-20 border-2 border-[rgb(0,255,255)]/50 flex items-center justify-center relative group">
                {/* Corner accents */}
                <div className="absolute top-0 left-0 w-3 h-3 border-t-2 border-l-2 border-[rgb(0,255,255)]" />
                <div className="absolute top-0 right-0 w-3 h-3 border-t-2 border-r-2 border-[rgb(0,255,255)]" />
                <div className="absolute bottom-0 left-0 w-3 h-3 border-b-2 border-l-2 border-[rgb(0,255,255)]" />
                <div className="absolute bottom-0 right-0 w-3 h-3 border-b-2 border-r-2 border-[rgb(0,255,255)]" />

                <span className="text-[rgb(0,255,255)] text-2xl font-bold">SN</span>
