...
const translations: Record<string, string> = {
  ...
  'onboarding.tier.includes': 'Features',
  'onboarding.tier.freeFeat1': 'Dashboards',
  'onboarding.tier.freeFeat2': 'Analyze a game for free',
  'onboarding.tier.indieFeat1': 'Dashboards + Compare',
  'onboarding.tier.indieFeat2': 'AI Agent Chat',
  'onboarding.tier.indieFeat3': 'Monthly PDF Reports',
  'onboarding.tier.entFeat1': 'Everything in Indie',
  'onboarding.tier.entFeat2': 'Custom volume',
  'onboarding.tier.subscribe': 'Subscribe',
  'onboarding.tier.tryFree': 'Start for Free',
