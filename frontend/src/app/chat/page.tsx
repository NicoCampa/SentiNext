    ...
    <AppLayout>
      <div className="mx-auto max-w-7xl space-y-8 sm:space-y-6 px-4 py-6 sm:px-6 lg:px-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,360px)]">
          ...
          <Card variant="glass" className="flex flex-col p-6 lg:sticky lg:top-32">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-semibold uppercase tracking-[0.25em] text-slate-400">Citations</h3>
              {selectedCitation ? (
            ...
            {selectedCitation ? (
              <>
                <div className="mt-3 flex flex-wrap items-center gap-2 text-xs text-slate-400">
                  <span className="rounded-full bg-slate-800/70 px-2 py-1 text-[11px] uppercase tracking-[0.2em] text-slate-300">
                    {formatSubcategory(selectedCitation.subcategory)}
                  </span>
                  <span>Review {selectedCitation.review_id}</span>
                </div>
              ...
              <div className="flex flex-1 flex-col items-center justify-center gap-3 text-center text-sm text-slate-400">
                <p>Open a citation to see the full review.</p>
                <p className="text-xs text-slate-500">Click any snippet in the chat to populate this drawer.</p>
              </div>
            )}
          </Card>
        </div>
