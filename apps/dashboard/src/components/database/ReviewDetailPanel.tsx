...
export function ReviewDetailPanel({
  ...
  return (
    <Card
      variant="glass"
      className="relative max-h-[calc(100vh-8rem)] overflow-auto p-6"
    >
      {copyToast && (
        <div className="absolute right-4 top-4 z-10 rounded-lg border border-emerald-500/50 bg-emerald-500/10 px-4 py-2 text-xs text-emerald-200">
          {copyToast}
        </div>
      )}
