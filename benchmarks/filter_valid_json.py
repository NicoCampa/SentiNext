...
g_all, g_filt, _, judge, ds = analyze_run(
    "benchmarks/results/20260206_001445_50f0c9a6", v1_tasks, v1_models
)
...
g_all, g_filt, _, judge, ds = analyze_run(
    "benchmarks/results/20260206_010301_910c9e1d", v2_tasks, v2_models
)
...
g_all, g_filt, _, judge, ds = analyze_run(
    "benchmarks/results/20260206_012234_65f59c2e", v2_tasks, v2_models
)
print_table(f"Valid JSON Only (dataset={ds}, judge={judge})", g_filt, v2_tasks, v2_models)
print_delta(g_all, g_filt, v2_tasks, v2_models)
