...
import { Github, Twitter, Mail, Info } from "lucide-react";
            ...
            <div className="container px-4 md:px-6 mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <Link href="/docs/taxonomy-reference" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground hover:text-[#00F0FF] transition-colors">Taxonomy Ref</Link>
                    </div>
                ...
                <div className="mt-16 p-4 border border-[#00F0FF]/10 bg-[#00F0FF]/5 rounded-sm flex gap-4 items-start opacity-40 hover:opacity-100 transition-opacity">
                    ...
                    <p className="text-[9px] font-mono uppercase tracking-widest leading-relaxed">
                        SentiNext is an independent autonomous intelligence protocol. We consume public Steam Community telemetry via API. We are not endorsed by, affiliated with, or supported by Valve Corporation. Steam and the Steam logo are trademarks of Valve Corporation.
                    </p>
                </div>
                ...
                <div className="mt-16 border-t border-[#00F0FF]/10 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-8">
                        <Link href="/impressum" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground hover:text-[#00F0FF]">Impressum</Link>
